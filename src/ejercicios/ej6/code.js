...
define(["jquery", "backbone", "hammer", "base", "activities/test.js", "activities/testtablet.js"], function($, Backbone, hammer, Base, TestActivity, TestActivityTablet) {
  "use strict";
  ...
  function startApp() {
    ...
    var win = Base.App.getWindow(),
        testScreen = win.isPhone()? new TestActivity() : new TestActivityTablet();
