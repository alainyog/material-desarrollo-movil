/* global window */
define(["jquery", "underscore", "backbone", "touchevents"], function($, _, Backbone, touchEvents) {
  "use strict";
    ...
    delegateEvents: function(events) {
      ...
      _.each(events, function(method, evstring) {
        ...
        var eventName = match[1],
            selector = match[2];
        if (!_.isFunction(method)) { method = this[events[evstring]]; }
        if (!_.isFunction(method)) { return this; }
        method = _.bind(method, this);
        if (eventName in touchEvents.events) {
          touchEvents.handle(eventName, this.$el, selector, method);
        }
      }, this);
